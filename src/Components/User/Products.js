                ...
                <div className="card mb-3" style={{ height: "100%" }}>
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      <span
                        className={`card-text ${plant.availability === "In Stock"
                          ? "text-success"
                          : "text-danger"
                          }`}
                      >
                    ...
                    <p className="m-0"><Link onClick={() => toggle(plant)}>Read more</Link>
                      <ProductDetailsModal show={show} toggle={toggle} data={product} />
                    </p>
                  </div>
                  <button
